def n_n(train2id, valid2id, test2id, type_constrain,  test2id_all, txt_1_1, txt_1_n, txt_n_1, txt_n_n):
	lef = {}
	rig = {}
	rellef = {}
	relrig = {}

	triple = open(train2id, "r")
	valid = open(valid2id, "r")
	test = open(test2id, "r")
